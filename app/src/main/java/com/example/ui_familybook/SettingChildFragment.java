...
import com.example.ui_familybook.databinding.FragmentSettingChildBinding;

public class SettingChildFragment extends Fragment {

    private FragmentSettingChildBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentSettingChildBinding.inflate(inflater, container, false);
